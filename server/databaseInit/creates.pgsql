...
CREATE TABLE IF NOT EXISTS player_stats (
    ...
    weapon_level INTEGER DEFAULT 10,           -- Used to determine chances of success when fighting enemies
...
CREATE TABLE IF NOT EXISTS locations (
    ...
    description TEXT,                                         -- Description of the location
    plot TEXT,                                                -- What a character will say when found
    preBoss TEXT,                                             -- Dialog that should appear before a boss
    postBoss TEXT,                                             -- Dialog that should appear before a boss
    xp_Reward TEXT,                                            -- How much XP recieved after successfully defeating a boss
    boos TEXT,                                                  -- Name of boss
);
...
CREATE TABLE IF NOT EXISTS items (
    ...
    sub_Type TEXT,                         -- sub set of item_type
);
